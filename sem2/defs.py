...
def get_decimal_between_number(
    text: str, number_min: decimal, number_max: decimal
) -> decimal:
    """
    Просит у пользователя ввести целое число между min и max и проверяет ввод
    """
...
def view_table_multiplication(
    start: int, finish: int, min_number: int, max_number: int, step_user: int
) -> print:
    """
